...
We simulated several situations with an effective bias in migration on a continuous landscape.
First, the ``biased'' situation, was a square landscape as above,
but with mean offspring location one tenth of a standard deviation up and to the right of the parent's location.
This produces reverse-time gene flow down and to the left.
Second, we simulated a ``valley'' in a $3 \times 5$ landscape as above, 
...
and thus an effective barrier across the ridge.
Third, we simulated a recent ``expansion'',
in which the middle 4/5 of the landscape was uninhabitable 400,000 generations,
...
\textbf{MAKE FIGURE OF THESE?}
\textbf{Merge with berow.}
