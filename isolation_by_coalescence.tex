...
We also simulated three situations on a continuous landscape that had an effective bias in migration.
First, the \textbf{biased} situation, was a square landscape as above,
...
Second, we simulated a \textbf{valley} in a landscape with a $3 \times 5$ aspect ratio as above, 
...
Third, we simulated a recent \textbf{expansion},
