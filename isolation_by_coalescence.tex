...
Taking the average over possible paths, this says that \revpoint{5}{2}
...
may be strongly misleading \revpoint{2}{7}
...
\begin{figure}
\centering
     \includegraphics[scale=1]{figs/4x4_grids}
    \caption{
...
\begin{figure}
\centering
    \includegraphics[width=0.49\textwidth]{figs/bias_coal_graph}
    \includegraphics[width=0.49\textwidth]{figs/bias_commute_graph}
    \includegraphics[width=0.49\textwidth]{figs/bias_coal_dists}
    \includegraphics[width=0.49\textwidth]{figs/bias_commute_dists}
\caption{
...
\begin{figure}
\centering
    \includegraphics[width=0.4\textwidth]{figs/barrier_locations}
    \includegraphics[width=0.4\textwidth]{figs/barrier_eems}
    \includegraphics[width=0.4\textwidth]{figs/barrier_coal_graph}
    \includegraphics[width=0.4\textwidth]{figs/barrier_commute_graph}
    \includegraphics[width=0.4\textwidth]{figs/barrier_coal_dists}
    \includegraphics[width=0.4\textwidth]{figs/barrier_commute_dists}
    \caption{
...
\begin{figure}
\centering
    \includegraphics[width=0.4\textwidth]{figs/valley_locations}
    \includegraphics[width=0.4\textwidth]{figs/valley_eems}
    \includegraphics[width=0.4\textwidth]{figs/valley_coal_graph}
    \includegraphics[width=0.4\textwidth]{figs/valley_commute_graph}
    \includegraphics[width=0.4\textwidth]{figs/valley_coal_dists}
    \includegraphics[width=0.4\textwidth]{figs/valley_commute_dists}
    \caption{
...
\begin{figure}
\centering
    \includegraphics[width=0.4\textwidth]{figs/expansion_locations}
    \includegraphics[width=0.4\textwidth]{figs/expansion_eems}
    \includegraphics[width=0.4\textwidth]{figs/expansion_coal_graph}
    \includegraphics[width=0.4\textwidth]{figs/expansion_commute_graph}
    \includegraphics[width=0.4\textwidth]{figs/expansion_coal_dists}
    \includegraphics[width=0.4\textwidth]{figs/expansion_commute_dists}
    \caption{
...
\centering
    ...
    \caption{
        ...
        interquartile range (box), and min--max (whiskers),
        for gene flow rates.
