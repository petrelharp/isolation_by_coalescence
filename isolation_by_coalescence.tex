...
Talk about Figure \ref{fig:h_val_comp}.
...
\begin{figure}
\centering
     \includegraphics[scale=.8]{figs/post_dists_5x3b_1_new}
...
\begin{figure}
\centering
 \includegraphics[scale=.34]{figs/tort_land5}
...
\begin{figure}
\centering
     \includegraphics[scale=.8]{figs/grid_5x3b_1}
    \caption{Medians of the posterior distributions of the inferred values of $g$ 
    for the first replicate of the $5 \times 3$ landscape with barriers.
