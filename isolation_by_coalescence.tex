...
Configuration the resulting simulations was similar to what is seen in 
...
\begin{figure}
\centering
     \includegraphics{figs/barrier_sample_locations_pretty}
...
\begin{figure}
\centering
    \includegraphics{figs/all_flat_divergences}
\caption{
    ...
    these are shown for two nonverlapping samples taken from three independent replicate simulations,
    each plotted against the the mean value across all replicates.
...
\centering
    ...
    \caption{
        ...
        posterior median migration rates 
            ...
            \textbf{(middle right)} the the resistance distance method.
        Last are shown the posterior distributions, for
            \textbf{(bottom left)} the coalescence time method and
            \textbf{(bottom right)} the the resistance distance method.
