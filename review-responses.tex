...
\reply{
    Good reference! We'd referred to the simpler version of \citet{strobeck1987average},
    and added this reference. \revref
}
...
\reply{
    This is a good point, but we'd rather keep the different results having to do with the same model
